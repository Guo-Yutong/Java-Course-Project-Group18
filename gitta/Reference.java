...
public class Reference implements GittaIO {

    /** Serial id. */
    private static final long serialVersionUID = 10L;
    /** Folder that refs live in. */
    private static final File REF_PATH =
                        GittaUtils.join(Repository.REPO_FOLDER, "refs");
    ...
    public static Reference getReference() {
        ...
        Reference reference = GittaIO.readObject(REF_PATH, Reference.class);
        if (reference == null) {
    ...
    private void saveFile() {
        GittaIO.writeObject(REF_PATH, this);
    }
